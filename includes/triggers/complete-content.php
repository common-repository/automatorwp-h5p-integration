...
class AutomatorWP_H5P_Complete_Content extends AutomatorWP_Integration_Trigger {
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User completes a content', 'automatorwp-h5p-integration' ),
            'select_option'     => __( 'User completes <strong>a content</strong>', 'automatorwp-h5p-integration' ),
            /* translators: %1$s: Content title. %2$s: Number of times. */
            'edit_label'        => sprintf( __( 'User completes %1$s %2$s time(s)', 'automatorwp-h5p-integration' ), '{content}', '{times}' ),
            /* translators: %1$s: Content title. */
            'log_label'         => sprintf( __( 'User completes %1$s', 'automatorwp-h5p-integration' ), '{content}' ),
            ...
            'options'           => array(
                'content' => automatorwp_utilities_ajax_selector_option( array(
                    'field'             => 'content',
                    'name'              => __( 'Content:', 'automatorwp-h5p-integration' ),
                    'option_none_value' => 'any',
                    'option_none_label' => __( 'any content', 'automatorwp-h5p-integration' ),
